          ...
          <div class="accordion" id="accordionExample">
              ...
              <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                  <p class="fs-14" style="line-height: 25px">
                    Yes. A PSP may submit a request on an MDA’s behalf, provided the PSP has the appropriate authorisation and is already processing fees for that MDA.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="accordion-item">
              ...
              <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                  <p class="fs-14" style="line-height: 25px">
                    Please refer to the Swagger documentation provided for the full payload structure and field descriptions.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="accordion-item">
              ...
              <div id="collapse4" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                  <p class="fs-14" style="line-height: 25px">
                    To find the correct receipt type, go to Settings > Agency Settings. There, you will see a comprehensive list of all MDAs 
